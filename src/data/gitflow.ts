...
export const gitflowNodes: InfoNode[] = [
  // --- branches track ---
  {
    ...
    detail: [
      'Most stable branch — every production release merges here after deployment',
      'Hotfixes branch from main (hotfix/ABC-456-…)',
      'Versioning lives in release-X.Y.Z branch names (MAJOR.MINOR.PATCH) — no git tags',
    ],
...
export const gitflowEdges: InfoEdge[] = [
  ...
  { id: 'g11', source: 'env-prod', target: 'branch-main', kind: 'forward', label: 'merge after deploy' },
