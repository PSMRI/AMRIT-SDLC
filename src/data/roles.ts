...
export const roles: Role[] = [
  ...
  },
  {
    ...
    responsibilities: [
      ...
      'Release-level QA sign-off before staging/production deployments — not individual tickets',
      'No critical/high-severity bugs open before greenlighting a release',
    ],
    deliverables: [
      'Release QA sign-offs',
